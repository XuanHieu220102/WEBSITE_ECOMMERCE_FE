...
const FormRegister = () => {
    ...
    const onFinish = (values) => {
        ...
        axios.post('http://localhost:8080/api/v1/auth/register', dataRegister, {
            headers: {
    ...
    return (
        <>
            ...
            <div className='modal-login'>
                <div className='modal-register-left'>
                    <div className='modal-register-image'>
                        <img className='image-logo-register' src="src\assets\logo-login2.PNG" alt="" />
                    </div>
                </div>
